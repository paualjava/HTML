...
LoadArr.push("images/page_1_7.png");
LoadArr.push("images/page_1_8.png");
LoadArr.push("images/page_2_0.jpg");
LoadArr.push("images/page_2_1.png");
...
LoadArr.push("images/page_2_7.png");
...
LoadArr.push("images/page_3_21.png");
LoadArr.push("images/page_3_3.png");
LoadArr.push("images/page_3_31.png");
...
LoadArr.push("images/page_6_3.png");
LoadArr.push("images/page_6_4.png");
LoadArr.push("images/page_6_5.png");
...
LoadArr.push("images/page_8_5.png");
LoadArr.push("images/page_9_0.jpg");
LoadArr.push("images/page_9_1.png");
LoadArr.push("images/page_arrow.png");
LoadArr.push("images/page_arrow2.png");
...
*/
	...
	var FristImg = ['images/page_1_2.png'];
	...
	if(device_height>960)
	{
		...
		$(".page_4_0,.page_5_0,.page_6_0,.page_7_0,.page_8_0,.page_9_0").css({"height":device_height,"background-size":background_size});
	...
	function bipinit() {
			...
			$("#button_mail").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_mail")
				{
					to_down=3;
					$("#button_mail").attr("style","background:url(images/page_3_21.png) no-repeat;background-size:157px 39px;background-position:0 0;width:157px;height:39px;top:46%;left:19%;position:absolute;z-index:0");
					$("#button_femail").attr("style","background:url(images/page_3_3.png) no-repeat;background-size:157px 39px;background-position:0 0;width:157px;height:39px;top:46%;right:19%;position:absolute;z-index:0");
					setTimeout(function (){$(".zhuquan3").hide();$(".zhuquan5").show();},800);
				}
			});
			$("#button_femail").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				to_down=3;
				if($(e.target).attr("id")=="button_femail")
				{
					$("#button_femail").attr("style","background:url(images/page_3_31.png) no-repeat;background-size:157px 39px;background-position:0 0;width:157px;height:39px;top:46%;right:19%;position:absolute;z-index:0");
					$("#button_mail").attr("style","background:url(images/page_3_2.png) no-repeat;background-size:157px 39px;background-position:0 0;width:157px;height:39px;top:46%;right:19%;position:absolute;z-index:0");
					setTimeout(function (){$(".zhuquan3").hide();$(".zhuquan4").show();},800);
				}
			});
			$("#computer_zhuquan6").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="computer_zhuquan6")
				{
					setTimeout(function (){$(".zhuquan5").hide();$(".zhuquan6").show();},800);
				}
			});
			$("#computer_zhuquan7").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="computer_zhuquan7")
				{
					setTimeout(function (){$(".zhuquan5").hide();$(".zhuquan7").show();},800);
				}
			});
			$("#computer_zhuquan8").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="computer_zhuquan8")
				{
					setTimeout(function (){$(".zhuquan5").hide();$(".zhuquan9").show();},800);
				}
			});
			$("#computer_zhuquan9").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="computer_zhuquan9")
				{
					setTimeout(function (){$(".zhuquan5").hide();$(".zhuquan8").show();},800);
				}
			});
			$("#button_buy_1").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_buy_1")
				{
					location.href="http://item.jd.com/1558659.html";
				}
			});
			$("#button_buy_2").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_buy_2")
				{
					location.href="http://item.jd.com/1546597.html";
				}
			});
			//page_arrow2
			$(".page_arrow2").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("class")=="page_arrow2")
				{
					$(".page_1_6,.page_1_7,.page_1_8,#bggray").show();
				}
			});
			$("#bggray").on("touchstart mousedown",function (e)
			{
				...
				{
					$(".page_1_6,.page_1_7,.page_1_8,#bggray").hide();
				}
			});	
			
			$("#button_buy_3").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_buy_3")
				{
					location.href="http://item.jd.com/1522947.html";
				}
			});
			$("#button_buy_4").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_buy_4")
				{
					location.href="http://item.jd.com/1558661.html";
				}
			});
			$(".button_change_sex").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("class")=="page_6_5 button_change_sex" || $(e.target).attr("class")=="page_7_3 button_change_sex" || $(e.target).attr("class")=="page_8_5 button_change_sex")
				{
					$("#button_femail").attr("style","background:url(images/page_3_3.png) no-repeat;background-size:157px 39px;background-position:0 0;width:157px;height:39px;top:46%;right:19%;position:absolute;z-index:0");
					$("#button_mail").attr("style","background:url(images/page_3_2.png) no-repeat;background-size:157px 39px;background-position:0 0;width:157px;height:39px;top:46%;right:19%;position:absolute;z-index:0");
					setTimeout(function (){$(".zhuquan6,.zhuquan7,.zhuquan8,.zhuquan9").hide();$(".zhuquan3").show();},100);
				}
			});
...
/*				TweenMax.to($('.s1-1') , .5 , { opacity : 1 , transform : 'scale(1)' , ease:Back.easeOut , delay : .2 , onComplete : function (){
	...
	//	document.title = ( PAGEINDEX - 1 )
		...
		case 1 : 
			size=1;
			buffer1=setInterval(function ()
			{
				
				background_size="73px "+size+"px";
				$(".page_3_4").css({"background-size":background_size});
				size++;
				if(size>130)
				clearInterval(buffer1);
			},30);
			size2=1;
			buffer2=setInterval(function ()
			{
				
				background_size2="102px "+size2+"px";
				$(".page_3_5").css({"background-size":background_size2});
				size2++;
				if(size2>376)
				clearInterval(buffer2);
			},10);
