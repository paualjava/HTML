...
<html>
<head>
<title>春节是一年最有钱的时候</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="viewport" content="width=640,target-densitydpi=device-dpi,user-scalable=no" />
<script type="text/javascript" src="js/jquery-1.8.3.min.js"></script>
<script type="text/javascript">
//base_url="http://172.16.65.31/HTML/money_163/";
base_url="http://www.wappmob.com/HTML/money_163/";
</script>

<link rel="stylesheet" href="css/css3.css" type="text/css" />
<link rel="stylesheet" href="css/css4.css" type="text/css" />
<link rel="stylesheet" href="css/jquery.jscrollpane.css" type="text/css" />
<link rel="stylesheet" type="text/css" href="css/other.css?14" />
<link rel="stylesheet" href="css/index.css?24" type="text/css" />
</head>
<body class="s">
...
<div id="main">
  <div id="content"> 
    ...
    <!------------------------------------------------------>
    <div id="bggray"></div>
        <div class="page_7_8"></div>
        
    <div class="box-step step0 zhuquan1">
     
    <div class="page_1_0"></div>
           <div class="page_1_1"></div>
        <div class="page_1_2"><input name="money" id="money" type="number"/></div>
        <div class="page_1_3" id="button_start"></div>
    ...
    <div class="box-step step1 zhuquan2">
      ...
      <div class="page_2_1"></div>
        ...
        <div class="page_2_5" id="page_2_5"></div>
        <div class="page_2_6" id="page_2_6"></div>
        <div class="page_2_7"></div>
        <div class="page_2_8"></div>
        <div class="page_2_9" id="button_go_index"></div>
        <div class="page_2_10" id="button_go3"></div>
   ...
   <div class="page_3_1"></div>
        ...
        <div class="page_3_4" id="page_3_4"></div>
        <div class="page_3_5" id="page_3_5"></div>
        <div class="page_3_6"></div>
        <div class="page_3_7" id="button_go_index2"></div>
        <div class="page_3_8" id="button_go4"></div>
        <div class="page_3_9"></div>
        <div class="page_3_10"></div>
    </div>
    ...
    <div class="page_4_1"></div>
        ...
        <div class="page_4_5" id="page_4_5"></div>
        <div class="page_4_6" id="page_4_6"></div>
        <div class="page_4_7"></div>
        <div class="page_4_8" id="button_go_index3"></div>
        <div class="page_4_9" id="button_go5"></div>
        <div class="page_4_10"></div>
        <div class="page_4_11"></div>
    ...
    <div class="page_5_0"></div>
      <div class="page_5_1"></div>
        ...
        <div class="page_5_3"></div>
        <div class="page_5_4"></div>
        <div class="page_5_5" id="page_5_5"></div>
        <div class="page_5_6" id="page_5_6"></div>
        <div class="page_5_7"></div>
        <div class="page_5_8"></div>
        <div class="page_5_9" id="button_next"></div>
        <div class="page_5_10"></div>
        <div class="page_5_11"></div>
    ...
    <div class="page_6_1"></div>
        <div class="page_6_2" id="button_test"></div>
    ...
    <div class="page_7_0"></div>
     <div class="page_7_1"></div>
        ...
        <div class="page_7_6" id="button_link"></div>
        <div class="page_7_7" id="button_share"></div>
...
<script src="js/zhuquan.js?21"></script> 
<script type="text/javascript">
$(function() {
