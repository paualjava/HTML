 ...
 */
	...
	styleInit : function(){
		...
		var autoHeight = $(window).width()*960/640;
	 	$('.p-ct').height($(window).height());
		$('.m-page').height(autoHeight);
	},
	...
	*/
	...
	init : function(){
		...
		$('<img />').attr('src',$('.wz1-2').attr('data-src'));	
		$('<img />').attr('src',$('.wz2-1').attr('data-src'));			
		$('<img />').attr('src',$('.wz2-2').attr('data-src'));		
		$('<img />').attr('src',$('.wz2-3').attr('data-src'));	
		$('<img />').attr('src',$('.wz-car').attr('data-src'));	
		$('<img />').attr('src',$('.wz-click').attr('data-src'));		
