...
LoadArr.push("images/page_1_1.png");
LoadArr.push("images/page_1_2.png");
LoadArr.push("images/page_1_3.png");
LoadArr.push("images/page_1_4.png");
LoadArr.push("images/page_1_5.png");
LoadArr.push("images/page_1_6.png");
LoadArr.push("images/page_2_0.jpg");
LoadArr.push("images/page_2_1.jpg");
LoadArr.push("images/page_2_10.png");
LoadArr.push("images/page_2_12.jpg");
LoadArr.push("images/page_2_2.png");
LoadArr.push("images/page_2_3.png");
LoadArr.push("images/page_2_4.png");
LoadArr.push("images/page_2_5.png");
LoadArr.push("images/page_2_6.png");
LoadArr.push("images/page_2_7.jpg");
LoadArr.push("images/page_2_8.png");
LoadArr.push("images/page_2_9.png");
LoadArr.push("images/page_3_0.jpg");
LoadArr.push("images/page_3_1.png");
LoadArr.push("images/page_3_10.jpg");
LoadArr.push("images/page_3_2.png");
LoadArr.push("images/page_3_3.png");
LoadArr.push("images/page_3_4.png");
LoadArr.push("images/page_3_5.png");
LoadArr.push("images/page_3_6.png");
LoadArr.push("images/page_3_7.png");
LoadArr.push("images/page_3_8.png");
LoadArr.push("images/page_4_0.jpg");
LoadArr.push("images/page_4_1.png");
LoadArr.push("images/page_4_11.jpg");
LoadArr.push("images/page_4_2.png");
LoadArr.push("images/page_4_3.png");
LoadArr.push("images/page_4_4.png");
LoadArr.push("images/page_4_5.png");
LoadArr.push("images/page_4_6.png");
LoadArr.push("images/page_4_7.png");
LoadArr.push("images/page_4_8.png");
LoadArr.push("images/page_4_9.png");
LoadArr.push("images/page_5_0.jpg");
LoadArr.push("images/page_5_1.png");
LoadArr.push("images/page_5_11.jpg");
LoadArr.push("images/page_5_2.png");
LoadArr.push("images/page_5_3.png");
LoadArr.push("images/page_5_4.png");
LoadArr.push("images/page_5_5.png");
LoadArr.push("images/page_5_6.png");
LoadArr.push("images/page_5_7.jpg");
LoadArr.push("images/page_5_8.jpg");
LoadArr.push("images/page_5_9.jpg");
LoadArr.push("images/page_6_0.jpg");
LoadArr.push("images/page_6_1.png");
LoadArr.push("images/page_6_2.png");
LoadArr.push("images/page_7_0.jpg");
LoadArr.push("images/page_7_1.png");
LoadArr.push("images/page_7_2.png");
LoadArr.push("images/page_7_3.png");
LoadArr.push("images/page_7_4.jpg");
LoadArr.push("images/page_7_5.jpg");
LoadArr.push("images/page_7_6.png");
LoadArr.push("images/page_7_7.png");
LoadArr.push("images/page_7_8.png");
LoadArr.push("images/page_8_0.jpg");
LoadArr.push("images/page_8_1.png");
LoadArr.push("images/page_8_2.png");
LoadArr.push("images/page_8_3.png");
LoadArr.push("images/page_8_4.png");
LoadArr.push("images/page_8_5.jpg");
LoadArr.push("images/page_8_6.jpg");
LoadArr.push("images/share.jpg");
LoadArr.push("images/tou.jpg");
...
*/
	...
	var FristImg = ['images/page_1_0.jpg'];

	var loader = new PxLoader();
	for(var i=0; i <FristImg.length;i++ ) {
		//loader.addImage(base_url+"resource/weixin_question/"+FristImg[i]);
	...
	if(device_height>960)
	{
		...
		$(".page_1_0,.page_2_0,.page_3_0,.page_4_0,.page_5_0,.page_6_0,.page_7_0,.page_8_0,.page_9_0,.page_10_0,.page_11_0,.page_12_0,.page_14_0,#newloading").css({"height":device_height,"background-size":background_size});
	...
	loader.addCompletionListener(function() {
		...
		for(i = 0; i <LoadArr.length;i++ ) {
			//loader.addImage(base_url+"resource/weixin_question/"+LoadArr[i]);
		...
		loader.addProgressListener(function(e) {
			...
			line_percent=((N1+N2)>80) ? 80 : N1+N2;
			$(".page_index_line").attr("style","height:3px; background:#fff;width:"+line_percent+"%;top:50%; position:absolute;left:10%;");
	...
	function bipinit() {
			...
			$("#button_start").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_start")
				{
					var   r   = /^[0-9]*[1-9][0-9]*$/;
					money=$("#money").val();
			...
			$("#button_share").on("touchstart mousedown",function (e)
			{
				...
				{
					$(".page_7_6,.page_7_7,.page_7_8,.page_7_9,#bggray").show();
				}
			});
			
			$("#button_go_index,#button_go_index2,#button_go_index3").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_go_index" || $(e.target).attr("id")=="button_go_index2" || $(e.target).attr("id")=="button_go_index3")
				{
					$(".zhuquan2,.zhuquan3,.zhuquan4").hide();
					$(".zhuquan1").show();
				}
			});
			$("#button_go3").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_go3")
				{
					$(".zhuquan2").hide();
					$(".zhuquan3").show();
				}
			});
			$("#button_go4").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_go4")
				{
					$(".zhuquan3").hide();
					$(".zhuquan4").show();
				}
			});
			$("#button_go5").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_go5")
				{
					$(".zhuquan4").hide();
					$(".zhuquan5").show();
				}
			});
			$("#button_next").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_next")
				{
					$(".zhuquan5").hide();
					$(".zhuquan6").show();
				}
			});
			$("#button_test").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_test")
				{
					$(".zhuquan6").hide();
					$(".zhuquan7").show();
				}
			...
			$("#button_link").on("touchstart mousedown",function (e)
			{
				...
				{
					location.href='http://fa.163.com/activity/silver/sign.do?from=pzweixin0202';
				}
			});
			...
			$("#button_submit").on("touchstart mousedown",function (e)
			{
				...
				if($(e.target).attr("id")=="button_submit")
				{
					...
					{
						$.post(base_url+"weixin_question/ajax_save_info",$(".this_form").serialize(),function (res)
						{
							if(res.info=="ok")
							{
								alert("提交成功!");
								...
								$(".zhuquan15").hide();$(".zhuquan14").fadeIn();
			...
			$("#bggray").on("touchstart mousedown",function (e)
			{
				...
				{
					$(".page_7_8,#bggray").hide();

				}
			});	
			$("#button_form_confirm").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_form_confirm")
				{
					$(".page_7_6,.page_7_7,.page_7_8,.page_7_9,#bggray").hide();
					clearInterval(page_13_3);
					page_13_3_signal=0;

				}
			});	
			$("#button_form_cancle").on("touchstart mousedown",function (e)
			{
				e.preventDefault();
				if($(e.target).attr("id")=="button_form_cancle")
				{
					$(".page_7_6,.page_7_7,.page_7_8,.page_7_9,#bggray").hide();
					clearInterval(page_13_3);
					page_13_3_signal=0;
			...
			document.getElementById("page_2_5").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_2_5_size=1;
			page_2_5_signal=1;
			page_2_5=setInterval(function ()
			{	
				if(page_2_5_signal==1)
				{
					if(page_2_5_size<=2)
					{
						if(page_2_5_size==1)
					background_url="background:url("+base_url+"images/page_2_5.png) no-repeat;background-size:620px 360px;background-position:0 0;width:297px;height:350px;top:39%;left:7%;position: absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_2_5.png) no-repeat;background-size:620px 360px;background-position:-320px 0;width:297px;height:350px;top:39%;left:7%;position: absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_2_5").attr("style",background_url);
					}
					page_2_5_size++;
					if(page_2_5_size>2)
					page_2_5_size=1;
			...
			document.getElementById("page_2_6").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_2_6_size=1;
			page_2_6_signal=1;
			page_2_6=setInterval(function ()
			{	
				if(page_2_6_signal==1)
				{
					if(page_2_6_size<=2)
					{
						if(page_2_6_size==1)
					background_url="background:url("+base_url+"images/page_2_6.png) no-repeat;background-size:500px 360px;background-position:0 0;width:237px;height:350px;top:39%;right:7%;position: absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_2_6.png) no-repeat;background-size:500px 360px;background-position:-250px 0;width:237px;height:350px;top:39%;right:7%;position: absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_2_6").attr("style",background_url);
					}
					page_2_6_size++;
					if(page_2_6_size>2)
					page_2_6_size=1;
			...
			document.getElementById("page_3_4").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_3_4_size=1;
			page_3_4_signal=1;
			page_3_4=setInterval(function ()
			{	
				if(page_3_4_signal==1)
				{
					if(page_3_4_size<=2)
					{
						if(page_3_4_size==1)
					background_url="background:url("+base_url+"images/page_3_4.png) no-repeat;background-size:600px 390px;background-position:0 0;width:288px;height:378px;top:36%;left:8%;position: absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_3_4.png) no-repeat;background-size:600px 390px;background-position:-300px 0;width:288px;height:378px;top:36%;left:8%;position: absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_3_4").attr("style",background_url);
					}
					page_3_4_size++;
					if(page_3_4_size>2)
					page_3_4_size=1;
			...
			document.getElementById("page_3_5").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_3_5_size=1;
			page_3_5_signal=1;
			page_3_5=setInterval(function ()
			{	
				if(page_3_5_signal==1)
				{
					if(page_3_5_size<=2)
					{
						if(page_3_5_size==1)
					background_url="background:url("+base_url+"images/page_3_5.png) no-repeat;background-size:500px 390px;background-position:0 0;width:238px;height:378px;top:36%;right:8%;position: absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_3_5.png) no-repeat;background-size:500px 390px;background-position:-250px 0;width:238px;height:378px;top:36%;right:8%;position: absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_3_5").attr("style",background_url);
					}
					page_3_5_size++;
					if(page_3_5_size>2)
					page_3_5_size=1;
			...
			document.getElementById("page_4_6").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_4_6_size=1;
			page_4_6_signal=1;
			page_4_6=setInterval(function ()
			{	
				if(page_4_6_signal==1)
				{
					if(page_4_6_size<=2)
					{
						if(page_4_6_size==1)
					background_url="background:url("+base_url+"images/page_4_6.png) no-repeat;background-size:540px 360px;background-position:0 0;width:264px;height:336px;top:39%;right:8%;position: absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_4_6.png) no-repeat;background-size:540px 360px;background-position:-270px 0;width:264px;height:336px;top:39%;right:8%;position: absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_4_6").attr("style",background_url);
					}
					page_4_6_size++;
					if(page_4_6_size>2)
					page_4_6_size=1;
			...
			document.getElementById("page_5_6").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_5_6_size=1;
			page_5_6_signal=1;
			page_5_6=setInterval(function ()
			{	
				if(page_5_6_signal==1)
				{
					if(page_5_6_size<=2)
					{
						if(page_5_6_size==1)
					background_url="background:url("+base_url+"images/page_5_6.png) no-repeat;background-size:560px 350px;background-position:0 0;width:265px;height:336px;top:32%;right:8%;position: absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_5_6.png) no-repeat;background-size:560px 350px;background-position:-280px 0;width:265px;height:336px;top:32%;right:8%;position: absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_5_6").attr("style",background_url);
					}
					page_5_6_size++;
					if(page_5_6_size>2)
					page_5_6_size=1;
			...
			document.getElementById("page_4_5").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_4_5_size=1;
			page_4_5_signal=1;
			page_4_5=setInterval(function ()
			{	
				if(page_4_5_signal==1)
				{
					if(page_4_5_size<=2)
					{
						if(page_4_5_size==1)
					background_url="background:url("+base_url+"images/page_4_5.png) no-repeat;background-size:560px 350px;background-position:0 0;width:267px;height:336px;top:39%;left:8%;position:absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_4_5.png) no-repeat;background-size:560px 350px;background-position:-280px 0;width:267px;height:336px;top:39%;left:8%;position:absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_4_5").attr("style",background_url);
					}
					page_4_5_size++;
					if(page_4_5_size>2)
					page_4_5_size=1;
			...
			document.getElementById("page_5_5").addEventListener("webkitAnimationEnd", function(){ //动画结束时事件
		
			page_5_5_size=1;
			page_5_5_signal=1;
			page_5_5=setInterval(function ()
			{	
				if(page_5_5_signal==1)
				{
					if(page_5_5_size<=2)
					{
						if(page_5_5_size==1)
					background_url="background:url("+base_url+"images/page_5_5.png) no-repeat;background-size:530px 350px;background-position:0 0;width:261px;height:336px;top:32%;left:8%;position:absolute;z-index:0";
				     else
				     	background_url="background:url("+base_url+"images/page_5_5.png) no-repeat;background-size:530px 350px;background-position:-265px 0;width:261px;height:336px;top:32%;left:8%;position:absolute;z-index:0";
					//$(".loadbar").html('<img src="'+base_url+'resource/clarks/images/loading_0'+loading_size+'.png"/>');
                    $("#page_5_5").attr("style",background_url);
					}
					page_5_5_size++;
					if(page_5_5_size>2)
					page_5_5_size=1;
...
/*				TweenMax.to($('.s1-1') , .5 , { opacity : 1 , transform : 'scale(1)' , ease:Back.easeOut , delay : .2 , onComplete : function (){
	...
	function PageUp ( index ){
				...
				return ;
				if(!Bstop || index>8 || to_down==7) return;
				Bstop = false;
				PAGEINDEX = index;
